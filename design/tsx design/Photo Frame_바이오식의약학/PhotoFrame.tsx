...
import icon1 from './바식1.png';
import icon2 from './바식2.png';
...
const PhotoFrame: FunctionComponent = () => {
  return (
    <div className={styles.photoFrame}>
      ...
      <b className={styles.b}>바이오식의약학</b>
      <div className={styles.div2}>2026</div>
      <div className={styles.challengeChanceChange}>"CHAllenge,  CHAnce,  CHAnge"</div>
      <img className={styles.icon} alt="바이오식의약학 아이콘 1" src={icon1} />
      <img className={styles.icon2} alt="바이오식의약학 아이콘 2" src={icon2} />
    </div>
  );
};
