...
import icon1 from './경영1.png';
import icon2 from './경영2.png';
...
const PhotoFrame: FunctionComponent = () => {
  return (
    <div className={styles.photoFrame}>
      ...
      <img className={styles.icon} alt="경영 아이콘 1" src={icon1} />
      <img className={styles.icon2} alt="경영 아이콘 2" src={icon2} />
      <div className={styles.div}>해솔네컷</div>
      <b className={styles.b}>경영학과</b>
