...
import icon1 from './미컴1.png';
import icon2 from './미컴2.png';
...
const PhotoFrame: FunctionComponent = () => {
  return (
    <div className={styles.photoFrame}>
      ...
      <img className={styles.icon} alt="미디어커뮤니케이션 아이콘 1" src={icon1} />
      <img className={styles.icon2} alt="미디어커뮤니케이션 아이콘 2" src={icon2} />
      <div className={styles.div}>해솔네컷</div>
      <b className={styles.b}>미디어커뮤니케이션</b>
