...
export const ElementMain = (): JSX.Element => {
    return (
        <div className="element-MAIN">
            ...
            <div className="frame-basic-frame">
                ...
                <img className="image" alt="Image" src={image88} />
            </div>
            ...
            <div className="frame-designed-frame">
                ...
                <img className="img" alt="Image" src={image116} />

                <img className="image-2" alt="Image" src={image121} />

                <img className="image-3" alt="Image" src={image114} />

                <img className="image-4" alt="Image" src={image123} />

                <img className="image-5" alt="Image" src={image120} />

                <img className="image-6" alt="Image" src={image122} />

                <img className="image-7" alt="Image" src={image119} />

                <img className="image-8" alt="Image" src={image118} />

                <img className="image-9" alt="Image" src={image117} />

                <img className="image-10" alt="Image" src={image115} />

                <img className="nurse" alt="Nurse" src={nurse3} />

                <img className="image-11" alt="Image" src={image87} />
